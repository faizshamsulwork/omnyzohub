    ...
    <>
      ...
      <div className={`md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1C1C1E] z-[9995] rounded-t-[32px] p-6 pb-12 shadow-[0_-20px_40px_rgba(0,0,0,0.1)] transform transition-transform duration-300 ease-out ${showMenu ? 'translate-y-0' : 'translate-y-full'}`}>
        ...
        <div className="space-y-2 mb-6 border-y border-gray-100 dark:border-gray-800 py-4">
          ...
          <Link href="/documents" onClick={() => setShowMenu(false)} className="flex items-center gap-4 p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors active:scale-95">
            <div className="w-10 h-10 rounded-full bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg></div>
            <span className="font-bold text-gray-700 dark:text-gray-200">Documents</span>
          </Link>
