...
export default function NewExpense() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!error) {
      toast.success("Expense recorded with documents.", { id: loadingToast });
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-6 border-t border-gray-200 dark:border-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-3">1. Vendor Invoice / Receipt</label>
              ...
              <div>
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-3">2. Payment Proof (Slip)</label>
